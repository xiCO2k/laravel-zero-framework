...
final class Installer extends AbstractInstaller
{
    ...
    public function install(): void
    {
        ...
        $this->task(
            ...
            function () {
                if (! File::exists(base_path('resources'))) {
                    File::makeDirectory(base_path('resources'), 0755, true, true);
                }
        ...
        $this->task(
            ...
            function () {
                if (! File::exists(base_path('storage'))) {
                    File::makeDirectory(base_path('storage'), 0755, true, true);
                }
                ...
                if (! File::exists(base_path('storage/framework'))) {
                    File::makeDirectory(base_path('storage/framework'), 0755, true, true);
                }
